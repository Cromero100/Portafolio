...
class InfiniteGridMenu {
  ...
  #init(onInit) {
    this.gl = this.canvas.getContext("webgl2", {
      antialias: true,
      alpha: true,
    }); // Alpha true para fondo transparente
    const gl = this.gl;
  ...
  #initTexture() {
    ...
    // Aumentado a 1024 para mejor calidad
    const cellSize = 1024;
  ...
  #animate(deltaTime) {
    ...
    // Escala de los discos (0.25 es default, puedes subir a 0.3 o 0.35 si quieres)
    const scale = 0.25;
...
/* =========================================
   REACT COMPONENT (WITH ANIMATED BACKGROUND)
   ========================================= */
...
const defaultItems = [
  {
    ...
    description: "Plataforma de ventas modular construida con microservicios.",
    tags: ["Next.js", "Node", "GraphQL"],
  },
  {
    image:
    ...
    description: "Visualización de datos financieros en tiempo real.",
  ...
  },
  {
    ...
    description: "Herramienta CLI para refactorización automática de código.",
    tags: ["Python", "OpenAI API", "Rust"],
  },
  {
    image:
    ...
    description: "Red social descentralizada enfocada en la privacidad.",
    ...
    <>
      ...
      <div className="relative w-full h-screen bg-[#050505] text-white overflow-hidden font-sans">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
          {/* Orbe 1: Violeta */}
          <div className="absolute top-0 left-[-10%] w-[70vw] h-[70vw] bg-purple-900/30 rounded-full mix-blend-screen filter blur-[100px] opacity-50 animate-blob" />

          {/* Orbe 2: Cyan */}
          <div className="absolute top-0 right-[-10%] w-[70vw] h-[70vw] bg-cyan-900/30 rounded-full mix-blend-screen filter blur-[100px] opacity-50 animate-blob animation-delay-2000" />

          {/* Orbe 3: Fucsia */}
          <div className="absolute -bottom-32 left-[20%] w-[70vw] h-[70vw] bg-fuchsia-900/30 rounded-full mix-blend-screen filter blur-[100px] opacity-50 animate-blob animation-delay-4000" />
        ...
        {/* === VIGNETTE / OSCURIDAD === */}
        <div className="absolute inset-0 bg-radial-gradient from-transparent via-[#050505]/50 to-[#050505] z-0 pointer-events-none" />

        {/* === CANVAS WEBGL === */}
        <canvas
          id="infinite-grid-menu-canvas"
          ref={canvasRef}
          className="absolute inset-0 w-full h-full cursor-grab active:cursor-grabbing outline-none z-10"
        />
        ...
        {activeItem && (
          <div
            className={`
              ...
              ${isMoving ? "opacity-20 blur-sm" : "opacity-100 blur-0"}
            `}
          >
            {/* Header */}
            <div className="flex justify-between items-start">
              <div className="text-xs font-mono tracking-widest opacity-50 uppercase text-cyan-200/70">
                Portfolio 2025
              </div>
              <div className="text-xl font-mono font-bold text-white/90">
                {String(activeIndex + 1).padStart(2, "0")}
                <span className="opacity-40 text-sm mx-2">/</span>
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mt-auto">
              ...
              <div className="pointer-events-auto">
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out" />
                </button>
              </div>
            </div>
          </div>
        ...
        {/* Drag Hint */}
        {!isMoving && (
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 pointer-events-none opacity-40 animate-pulse text-cyan-100">
